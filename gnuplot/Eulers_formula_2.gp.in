...
if (plotAll != 0) \
	...
	for [x_new = 0:index] \
	\
	arrow from (x_new * plot_inc),0,0 to (x_new * plot_inc),0,cos((pi / 2) * x_new * plot_inc) linecolor "cyan"   nohead
...
if (plotAll != 0) \
	...
	for [x_new = 0:index] \
	\
	arrow from (x_new * plot_inc),0,0 to (x_new * plot_inc),sin((pi / 2) * x_new * plot_inc),0 linecolor "magenta"  nohead

set \
\
for [x_new = 0:index] \
\
arrow from (x_new * plot_inc),0,0 to (x_new * plot_inc),sin((pi / 2) * x_new * plot_inc),cos((pi / 2) * x_new * plot_inc) linecolor "orange" nohead

if (plotAll != 0) \
	\
	splot \
	\
	u, 0,                 cos((pi / 2) * u) linecolor "cyan"    linewidth 0.5 notitle, \
	u, sin((pi / 2) * u), 0                 linecolor "magenta" linewidth 0.5 notitle, \
	u, sin((pi / 2) * u), cos((pi / 2) * u) linecolor "orange"  linewidth 0.5 notitle; \
else \
	\
	splot \
	\
